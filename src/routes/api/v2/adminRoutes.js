...
const CounsellorAnalyticsController = require("../../../controllers/v2/counsellorAnalyticsController");
...
/**
 * CONSELLOR ANALYTICS getCounsellorDashboard /age-range
 */

router.get(
    "/counsellors/gender/:accountType",
    // AuthMiddleware.protect,
    // AuthMiddleware.restrictTo("admin"),
    CounsellorAnalyticsController.getGender
);
...
router.get(
    ...
    // AuthMiddleware.protect,
    // AuthMiddleware.restrictTo("admin"),
    CounsellorAnalyticsController.getCounsellorDashboard
);

router.get(
    "/counsellors/age-range",
    // AuthMiddleware.protect,
    // AuthMiddleware.restrictTo("admin"),
    CounsellorAnalyticsController.getAgeRangeDistribution
);
